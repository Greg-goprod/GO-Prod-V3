/*
  # Create drivers table with enums

  1. New Types
    - `language` enum for supported languages
    - `hired_year` table for managing hire years
  
  2. Tables
    - `drivers` table with all required fields
    - `hired_year` table for managing valid hire years
    - `driver_languages` junction table for many-to-many relationship
